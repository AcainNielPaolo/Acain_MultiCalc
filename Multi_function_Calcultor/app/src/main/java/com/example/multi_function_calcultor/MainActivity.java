package com.example.multi_function_calcultor;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bb1 = findViewById(R.id.btncp1);
        bb2 = findViewById(R.id.btncp2);
        bpi = findViewById(R.id.btnpie);
        bdot = findViewById(R.id.btndecimal);
        bequal = findViewById(R.id.btnresult);
        bplus = findViewById(R.id.btnadd);
        bminus = findViewById(R.id.btnsubtract);
        bmul = findViewById(R.id.btnmultiply);
        bdiv = findViewById(R.id.btndivide);
        binv = findViewById(R.id.btnv);
        bsqrt = findViewById(R.id.btnsquareroot);
        bsquare = findViewById(R.id.btnxpowerof2);
        bfact = findViewById(R.id.btnx);
        bln = findViewById(R.id.btnln);
        bsin = findViewById(R.id.btnsin);
        bcos = findViewById(R.id.btncos);
        btan = findViewById(R.id.btntan);
        blog = findViewById(R.id.btnlog);

        tvmain = findViewById(R.id.txtview2);
        tvsec = findViewById(R.id.txtview1);
